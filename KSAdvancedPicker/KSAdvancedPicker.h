...
@property (nonatomic, unsafe_unretained) id<KSAdvancedPickerDelegate> delegate;

- (id) initWithFrame:(CGRect)frame delegate:(id<KSAdvancedPickerDelegate>)aDelegate tag:(NSInteger)selTag;
